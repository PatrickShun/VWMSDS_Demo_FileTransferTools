...
def statistics_results_wav():
    ...
    print('{str: <{len}}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}'.format(titles[0], titles[1], titles[2], titles[3],
                                                                         ...
                                                                         titles[8], titles[9], len=lens, str='Audio_type_wav'))

    # 创建保存路径的字典
    language_dev, language_loc, language_dev_num, language_loc_num = dict.fromkeys(('en_us', 'zh_cn', 'zh_hk', 'zh_sc', 'zh_tw'), '0'), \
                                                                     dict.fromkeys(('en_us', 'zh_cn', 'zh_hk', 'zh_sc', 'zh_tw'), '0'), \
                                                                     dict.fromkeys(('en_us', 'zh_cn', 'zh_hk', 'zh_sc', 'zh_tw',), 0),  \
                                                                     dict.fromkeys(('en_us', 'zh_cn', 'zh_hk', 'zh_sc', 'zh_tw',), 0)
    ...
    for wt in wavtype:
        for i in range(1, 5):
            ...
            print("{str: <{len}}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}".format(language_dev_num['en_us'], language_loc_num['en_us'],
                                                                                 language_dev_num['zh_cn'], language_loc_num['zh_cn'],
                                                                                 language_dev_num['zh_hk'], language_loc_num['zh_hk'],
                                                                                 language_dev_num['zh_sc'], language_loc_num['zh_sc'],
                                                                                 language_dev_num['zh_tw'], language_loc_num['zh_tw'],
                                                                                 len=lens, str=wt + str(i)))
...
def statistics_results_txt():
    ...
    print('{str: <{len}}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}'.format(titles[0], titles[1], titles[2], titles[3],
                                                                         titles[4], titles[5], titles[6], titles[7],
                                                                         titles[8], titles[9], len=lens, str='Test_txt'))
